...
from pipeline.extract.extract_airports_database import (
...
class TestAirportsDatabase(unittest.TestCase):
    ...
    @patch('pipeline.extract.extract_airports_database.requests.get')
    ...
    @patch('pipeline.extract.extract_airports_database.requests.get')
    @patch('pipeline.extract.extract_airports_database.zipfile.ZipFile')
    ...
    def test_path_construction(self):
        ...
        if os.name == 'nt':  # Windows
            mock_file_path = Path(
                'C:\\fake\\src\\pipeline\\extract\\extract_airports_database.py'
            )
            ...
            mock_file_path = Path(
                '/fake/src/pipeline/extract/extract_airports_database.py'
            )
            expected_root = '/fake'
    ...
    def test_real_download_integration(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            import pipeline.extract.extract_airports_database as module
